 ...
 *
 * Description: Marks all rules which modify the structure of the tree graph being
 *              processed.
 *
...
/**
 * Marks all rules which modify the structure of the tree graph being
 * processed.
 * @author <a href="mailto:jsanleandro@yahoo.es"
 *         >Jose San Leandro Armend&aacute;riz</a>
 * @version $Revision$
 */
public interface StructureShaperRule
    extends  Rule
{
}
